...
export async function iniciarLoginAutomático() {
  try {
    if (!browser || !page) {
...
const dados = await page.evaluate(() => {
  ...
  return {
    ...
    sendToFrontend("Ops, este RG não foi encontrado na base de dados.");
    return { sucesso: false, mensagem: "Ops, este RG não foi encontrado na base de dados.", erro: err.message };
  }
}
